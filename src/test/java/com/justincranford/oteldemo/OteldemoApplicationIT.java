...
class OteldemoApplicationIT extends AbstractIT {
    ...
    @Test
    void generateOpenTelemetryOTLPTrafficForLogs() {
        doLoopInThread(currentIteration -> log.info("Log message {}", currentIteration), 1000, 3000, "logging");
    }

    @Test
    void generateOpenTelemetryOTLPTrafficForCounterMetric() {
    ...
    @Test
    void generateOpenTelemetryOTLPTrafficForHistogramMetric() {
    ...
    @Test
    void generateOpenTelemetryOTLPTrafficForGaugeMetric() {
    ...
    @Test
    void generateOpenTelemetryOTLPTrafficForActuatorTraces() {
    ...
    @Test
    void generateOpenTelemetryOTLPTrafficForCustomControllerTrace() {
